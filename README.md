...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/serialize-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10639&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/serialize-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `serialize` can be installed with:

```
conda install serialize
```

It is possible to list all of the versions of `serialize` available on your platform with:
